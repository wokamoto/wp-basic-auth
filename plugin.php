...
License:
 Released under the GPL license
  ...
  Copyright 2013-2022 wokamoto (email : wokamoto1973@gmail.com)
...
';
	...
	function __construct(){
		...
		add_action( 'template_redirect', [$this, 'basic_auth'], 1 );
	...
	public function activate(){
		...
		file_put_contents(
			ABSPATH.'.htaccess',
			self::HTACCES_REWRITE_RULE . $htaccess
		);
	}
	...
	public function deactivate(){
		...
		file_put_contents(
			ABSPATH.'.htaccess',
			str_replace( self::HTACCES_REWRITE_RULE, '', $htaccess )
		);
	}
